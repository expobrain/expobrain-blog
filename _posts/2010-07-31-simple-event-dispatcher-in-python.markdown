...
[Here]({{ site.url }}/assets/2010/07/eventdispatcher.py.zip) you can download the source code for the Event and EventDisatcher classes with also the example code.
